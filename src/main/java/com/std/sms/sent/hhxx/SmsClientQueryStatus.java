 ...
 * </p>
 * @author: myb858 
 * @since: 2015年11月5日 下午3:36:30 
 * @history:
 */
public class SmsClientQueryStatus {

    /**
     * 第四章 状态报告接口
     * 其一：发送方式，默认为POST<br/>
     * 其二：发送内容编码方式，默认为UTF-8
     * @param url：必填--发送连接地址URL--比如>http://118.145.30.35/statusApi.aspx
     * @param userid：必填--用户ID，为数字
     * @param account：必填--用户帐号
     * @param password：必填--用户密码
     * @return 返回状态报告
     */
    public static String queryStatus(String url, String userid,
